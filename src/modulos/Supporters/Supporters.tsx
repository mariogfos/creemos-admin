...
const Supporters = () => {
  ...
  const fields = useMemo(() => {
    return {
      ...
      prov_id: { rules: ["required"], api: "ae", label: "Provincia", form: false, list: { width: "150px", onRender: ({ item, extraData: listExtraData }: any) => listExtraData?.provs?.find( (prov: any) => prov?.id == item?.prov_id )?.name }},
